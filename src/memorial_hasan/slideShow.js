...
function slideShow() {
  ...
  var globals = {
    slideDelay: 3000, // The time interval between consecutive slides.
    fadeDelay: 20, // The time interval between individual opacity changes. This should always be much smaller than slideDelay.  
  ...
  function initializeSlideShowMarkup() {  
	...
	globals.wrapperObject.style.marginLeft = "auto";
	globals.wrapperObject.style.marginRight = "auto";
	globals.wrapperObject.style.left = "-20px";
